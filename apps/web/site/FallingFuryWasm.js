...
// include: /var/folders/zb/8x4x87m1691cj3v52mm1v1n80000gn/T/tmpayvgb6w7.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'bin/FallingFuryWasm.data';
      var REMOTE_PACKAGE_BASE = 'FallingFuryWasm.data';
...
Module['FS_createPath']("/assets/fonts", "1", true, true);
Module['FS_createPath']("/assets/fonts", "2", true, true);
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_bin/FallingFuryWasm.data');
      }
      Module['addRunDependency']('datafile_bin/FallingFuryWasm.data');
    ...
    loadPackage({"files": [{"filename": "/assets/fonts/1/About.md", "start": 0, "end": 3876}, {"filename": "/assets/fonts/1/About.txt", "start": 3876, "end": 7709}, {"filename": "/assets/fonts/1/BebasNeue-Regular.eot", "start": 7709, "end": 32374}, {"filename": "/assets/fonts/1/BebasNeue-Regular.otf", "start": 32374, "end": 74574}, {"filename": "/assets/fonts/1/BebasNeue-Regular.ttf", "start": 74574, "end": 135150}, {"filename": "/assets/fonts/1/BebasNeue-Regular.woff", "start": 135150, "end": 158802}, {"filename": "/assets/fonts/1/BebasNeue-Regular.woff2", "start": 158802, "end": 180562}, {"filename": "/assets/fonts/1/OFL-FAQ.txt", "start": 180562, "end": 239491}, {"filename": "/assets/fonts/1/OFL.txt", "start": 239491, "end": 243828}, {"filename": "/assets/fonts/1/Try_BebasNeuePro.txt", "start": 243828, "end": 244043}, {"filename": "/assets/fonts/2/BlestiveScript.otf", "start": 244043, "end": 430075}], "remote_package_size": 430075});

  })();

// end include: /var/folders/zb/8x4x87m1691cj3v52mm1v1n80000gn/T/tmpayvgb6w7.js
// include: /var/folders/zb/8x4x87m1691cj3v52mm1v1n80000gn/T/tmplmch17xy.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /var/folders/zb/8x4x87m1691cj3v52mm1v1n80000gn/T/tmplmch17xy.js
// include: /var/folders/zb/8x4x87m1691cj3v52mm1v1n80000gn/T/tmp933_g701.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /var/folders/zb/8x4x87m1691cj3v52mm1v1n80000gn/T/tmp933_g701.js
...
function findWasmBinary() {
  return locateFile('FallingFuryWasm.wasm');
}
